...
public class IbanBerechnen {
	...
	public static String kontonummergedoens(String nummer) {
		String nummer1 = "";
	...
	public static String leanderkennungen(String laenderkennung) {
		...
		int buchstabe1 = laenderkennung.charAt(0)-64+9; //ascii
	...
	public static String erzeugeIban (String laenderkennung, String blz, String nummer) {
		String iban = laenderkennung
				+""+lifemudolo
				(blz+""+kontonummergedoens(nummer)+""
				+leanderkennungen(laenderkennung)+"")+""+blz+kontonummergedoens(nummer);
